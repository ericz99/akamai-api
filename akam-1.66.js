    ...
    bmak && bmak.hasOwnProperty("ver") && bmak.hasOwnProperty("sed")
      ...
      : {
          ...
          sed: function () {
            ...
            var e;
            e =
              void 0 !== navigator.webdriver && navigator.webdriver ? "1" : "0";
            var n;
          ...
          cma: function (a, t) {
            try {
              if (
                (1 == t && bmak.mme_cnt < bmak.mme_cnt_lmt) ||
                (1 != t && bmak.mduce_cnt < bmak.mduce_cnt_lmt)
              ) {
          ...
          cpa: function (a, t) {
            try {
              var e = !1;
              if (
                (1 == t && bmak.pme_cnt < bmak.pme_cnt_lmt) ||
                (1 != t && bmak.pduce_cnt < bmak.pduce_cnt_lmt)
              ) {
            ...
            if (n) {
              for (var o in a)
                (t.style.fontFamily = a[o]),
                  n.appendChild(t),
                  (e +=
                    a[o] + ":" + t.offsetWidth + "," + t.offsetHeight + ";"),
                  n.removeChild(t);
          ...
          gf: function (a) {
            var t;
            if (
              ((t = null == a ? document.activeElement : a),
          ...
          cta: function (a, t) {
            try {
              if (
                (1 == t && bmak.tme_cnt < bmak.tme_cnt_lmt) ||
                (1 != t && bmak.tduce_cnt < bmak.tduce_cnt_lmt)
              ) {
                var e = a || window.event,
                  n = -1,
                  o = -1;
          ...
          cdoa: function (a) {
            try {
              if (
                ...
                void 0 !== a.isTrusted && !1 === a.isTrusted && (m += ",0"),
            ...
            try {
              if (
                ...
                var k =
                  ...
                  "," +
                  d;
                void 0 !== a.isTrusted && !1 === a.isTrusted && (k += ",0"),
            ...
            try {
              if ((bmak.bpd(), 0 == bmak.sdfn.length)) {
                if (
                  ...
                  for (
                    var a = document.getElementsByName("bm-telemetry"), t = 0;
                    t < a.length;
                    t++
                  )
                    a[t].value = bmak.sensor_data;
              } else
                for (var t = 0; t < bmak.sdfn.length; t++)
                  document.getElementById(bmak.sdfn[t]) &&
                    (document.getElementById(bmak.sdfn[t]).value =
                      bmak.sensor_data);
            } catch (a) {
          ...
          cookie_chk_read: function (a) {
            if (document.cookie)
              for (
                var t = a + "=", e = document.cookie.split("; "), n = 0;
                n < e.length;
                n++
              ) {
                var o = e[n];
          ...
          bpd: function () {
            ...
            try {
              ...
              var P = "";
              try {
                a.stack && "string" == typeof a.stack
                  ? (P = a.stack.replace(/\"/g, "\\'"))
                  : "string" == typeof a && (P = a.replace(/\"/g, "\\'")),
                  (P = P.slice(0, 1e3)),
                  bmak.sd_debug(",s2:" + P),
                  (bmak.sensor_data =
                    bmak.ver +
          ...
          mn_poll: function () {
            if (0 == bmak.mn_state) {
              ...
              null != t &&
                (bmak.mn_update_challenge_details(t),
                bmak.mn_sen &&
                  ((bmak.mn_state = 1),
                  (bmak.mn_mc_indx = 0),
                  (bmak.mn_al = []),
          ...
          applyFunc: function () {
            ...
            (t = e.shift()),
              bmak.listFunctions[t] &&
                bmak.listFunctions[t].apply(bmak.listFunctions, e);
          },
        };
if (
  ((function (a) {
        ...
        if (!t.sf4() && document.body) {
          ...
          for (
            ...
            (b = i.childNodes[c]),
              (m[c] = b.offsetWidth),
              (r[c] = b.offsetHeight);
          if ((document.body.removeChild(i), bmak.get_cf_date() - e > a))
            return "";
          var d = [
              "Geneva",
              "Lobster",
